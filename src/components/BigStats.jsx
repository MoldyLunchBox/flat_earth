...
return(
    <div class="px-6 mx-auto pt-6 2xl:container">
    <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <div class="md:col-span-2 lg:col-span-1" >
            <div class="h-full py-8 px-6 space-y-6    text-white bg-black ">
                ...
                <div>
                    <h5 class="text-xl text-white text-center">Air Pollution</h5>
                    <div class="mt-2 flex justify-center gap-4">
                        <h3 class="text-3xl font-bold text-white">Over 90% </h3>
                    ...
                    <span class="block text-center text-white"> of the world's population breathes polluted air</span>
                </div>
                <table class="w-full text-white">
                    <tbody>
                        <tr>
                            <td class="py-2">Europ</td>
        ...
        <div>
            <div class="h-full py-6 px-6 bg-black">
                <h5 class="text-xl text-white">Freshwater Depletion</h5>
                <div class="my-8">
                    <h1 class="text-5xl font-bold text-white">40%</h1>
                    <span class="text-white">of the world's largest groundwater systems are being overexploited</span>
                </div>
                ...
                <table class="mt-6 -mb-2 w-full text-white">
                    <tbody>
                        <tr>
                            <td class="py-2">From individuals</td>
                            <td class="text-white">896</td>
                            <td>
                                <svg class="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect opacity="0.4" width="17" height="21" rx="1" fill="#e4e4f2"/>
                        ...
                        <tr>
                            <td class="py-2">From industries</td>
                            <td class="text-white">1200</td>
                            <td>
                                <svg class="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect opacity="0.4" width="17" height="21" rx="1" fill="#e4e4f2"/>
        ...
        <div>
            <div class="lg:h-full py-8 px-6 text-white   bg-black">
                ...
                <div class="mt-6">
                    <h5 class="text-xl text-white text-center">Overfishing</h5>
                    <div class="mt-2 flex justify-center gap-4">
                        <h3 class="text-3xl font-bold text-white">30%</h3>
                        <div class="flex items-end gap-1 text-green-500">
                            <svg class="w-3" viewBox="0 0 12 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M6.00001 0L12 8H-3.05176e-05L6.00001 0Z" fill="currentColor"/>
                            </svg>
                    ...
                    <span class="block text-center text-white">of the world's fish stocks are overexploited</span>
                </div>
                <table class="mt-6 -mb-2 w-full text-white">
                    <tbody>
                        <tr>
