...
return(
    <div className="px-6 mx-auto pt-6 2xl:container">
    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <div className="md:col-span-2 lg:col-span-1" >
            <div className="h-full py-8 px-6 space-y-6    text-white bg-black ">
                ...
                <div>
                    <h5 className="text-xl text-white text-center">Air Pollution</h5>
                    <div className="mt-2 flex justify-center gap-4">
                        <h3 className="text-3xl font-bold text-white">Over 90% </h3>
                    ...
                    <span className="block text-center text-white"> of the world's population breathes polluted air</span>
                </div>
                <table className="w-full text-white">
                    <tbody>
                        <tr>
                            <td className="py-2">Europ</td>
        ...
        <div>
            <div className="h-full py-6 px-6 bg-black">
                <h5 className="text-xl text-white">Freshwater Depletion</h5>
                <div className="my-8">
                    <h1 className="text-5xl font-bold text-white">40%</h1>
                    <span className="text-white">of the world's largest groundwater systems are being overexploited</span>
                </div>
                ...
                <table className="mt-6 -mb-2 w-full text-white">
                    <tbody>
                        <tr>
                            <td className="py-2">From individuals</td>
                            <td className="text-white">896</td>
                            <td>
                                <svg className="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect opacity="0.4" width="17" height="21" rx="1" fill="#e4e4f2"/>
                        ...
                        <tr>
                            <td className="py-2">From industries</td>
                            <td className="text-white">1200</td>
                            <td>
                                <svg className="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect opacity="0.4" width="17" height="21" rx="1" fill="#e4e4f2"/>
        ...
        <div>
            <div className="lg:h-full py-8 px-6 text-white   bg-black">
                ...
                <div className="mt-6">
                    <h5 className="text-xl text-white text-center">Overfishing</h5>
                    <div className="mt-2 flex justify-center gap-4">
                    ...
                    <span className="block text-center text-white">of the world's fish stocks are overexploited</span>
                </div>
                <table className="mt-6 -mb-2 w-full text-white">
                    <tbody>
                        <tr>
                        ...
                        <tr>
                            <td className="py-2">Other</td>
                            <td className="text-white">650</td>
                            <td>
                                <svg className="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect opacity="0.4" width="17" height="21" rx="1" fill="#e4e4f2"/>
                                    <rect opacity="0.4" x="19" width="14" height="21" rx="1" fill="#e4e4f2"/>
