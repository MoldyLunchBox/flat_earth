...
export const Stats = () => {
    return (
        <div className="flex  sm:divide-y-0 sm:divide-x mx-auto divide-y divide-dashed flex-col w-fit  bg-white rounded-xl sm:flex-row shadow">

            <div className="p-4 flex space-y-1  border-r-[gray] flex-col max-w-[190px]">
                <div className="stat-title">Biodiversity Loss</div>
                <div className='flex justify-between flex-row'>

                    <div className="stat-value"> 1 M </div>
                    <div className="right-0 text-secondary">
                        <div className='w-10'>
                            <svg viewBox="0 0 1024 1024" className="icon" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M855.1 262.6v21.6c0 10.7-8.7 19.4-19.4 19.4H804c-8.8 37.3-42.4 65.2-82.4 65.2H497.1v125.9c0 15.1-1.1 30.2-3.3 45.1 0 0.2 0 0.3-0.1 0.4-2.9 19.4-8.3 38.4-14.1 57-7.5 24.6-22.2 49-23.3 51h57.1l45.9-45.8c-4.1-29.3 5.7-59.3 26.9-80.5 24-24 59.2-33.4 92-24.7 6.7 1.8 11.9 7 13.7 13.7 8.7 32.8-0.7 68-24.7 92-18 18-42.5 27.9-67.5 27.9-4.3 0-8.7-0.3-13.1-0.9l-18.4 18.4h151.2c10.7 0 19.4 8.7 19.4 19.4s-8.7 19.4-19.4 19.4H430.1c-1.2 1.5-6.9 8.4-8.5 10.3l-0.4 0.5v137.9c0 10.7-8.7 19.4-19.4 19.4-19.4 0-37.3-6.1-52.1-16.5v49.2c0 10.7-8.7 19.4-19.4 19.4-19.3 0-37.3-6.1-52-16.5v49.9c0 10.7-8.7 19.4-19.4 19.4-50.1 0-90.9-40.8-90.9-90.9V373.8c0-43.1 8.7-84.8 25.8-124 0 0 26.7-59.3 70.2-100.1 42.5-39.9 89.6-59.7 89.6-59.7 39.2-17.1 80.9-25.8 123.9-25.8h179.1c47.6 0 93.6 17.1 129.5 48.1 1.9 1.6 9.1 8.3 10.8 10 37.6 37.4 58.2 87.2 58.2 140.3z" fill="#663333"></path><path d="M806.3 206.7c12.3 34 10 58 10 58h-92.7c1.4-42 20.7-81 52.7-107.8 0.1 0.1 20.2 22.7 30 49.8z" fill="#FE6865"></path><path d="M497.1 303.5h266c-7.3 15.6-23.2 26.4-41.5 26.4H497.1v-26.4z" fill="#FFCC66"></path><path d="M656.4 532.7c0.7 15.7-5.1 31.3-16.5 42.6-11.3 11.3-26.9 17.2-42.6 16.4-0.7-15.7 5.1-31.3 16.5-42.6 11.3-11.3 26.9-17.1 42.6-16.4z" fill="#6A973A"></path><path d="M458.3 417.5v77.1c0 13.3-1 26.7-2.9 39.8 0 0.2 0 0.3-0.1 0.4-2.5 16.8-6.6 33.5-12.2 49.5 0 0-10.4 28.5-26.4 54.6-15.1 24.7-37.8 47.2-37.8 47.2-9.5 9.5-19.6 18.2-30.3 26.2-2.7-7.5-9.8-12.9-18.3-12.9-10.7 0-19.4 8.7-19.4 19.4v145.9c-19.1-7.7-32.6-26.5-32.6-48.3V704.8c53-31.2 88.6-88.9 88.6-154.7v-69.7c0-54.8-44.6-99.5-99.5-99.5-10.7 0-19.4 8.7-19.4 19.4s8.7 19.4 19.4 19.4c16.2 0 31.4 6.3 42.9 17.8 11.4 11.5 17.8 26.7 17.8 42.9v69.7c0 71-52.9 129.9-121.3 139.4V373.8c0-37.7 7.6-74.2 22.5-108.4 0 0 12.5-29.2 38.9-63.3 27.6-35.7 57.3-52.4 58.2-52.9-16.5 26.9-26 58.5-26 92.3 0.1 91 69.3 166.3 157.9 176z" fill="#FE6865"></path><path d="M458.3 104.4v274c-67.1-9.5-119-67.3-119-137 0-69.8 51.8-127.6 119-137z" fill="#FFFFFF"></path><path d="M403.6 188.1c12.4 0 22.4 10 22.4 22.4 0 12.4-10 22.4-22.4 22.4-12.4 0-22.4-10-22.4-22.4 0-12.4 10-22.4 22.4-22.4z" fill="#663333"></path><path d="M382.4 735.1v77.3c-19.1-7.7-32.7-26.5-32.7-48.3v-5.8c11.5-7 22.4-14.8 32.7-23.2zM239.5 721.9V917.5c-19.1-7.7-32.6-26.5-32.6-48.3V728.6c11.2-1.3 22.1-3.5 32.6-6.7z" fill="#FE6865"></path><path d="M747.1 131c-26.5-18.2-58-28.1-90.4-28.1H497.1v161.8h187.7c1.5-51.6 24.1-99.8 62.3-133.7z" fill="#FFCC66"></path></g></svg>
                        </div>
                    </div>
                </div>
